...
library Attack {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ggg", name: "Attack", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x7462676767000000000000000000000041747461636b00000000000000000000);
