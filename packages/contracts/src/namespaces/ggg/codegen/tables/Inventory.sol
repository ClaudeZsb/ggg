...
library Inventory {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ggg", name: "Inventory", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626767670000000000000000000000496e76656e746f727900000000000000);
