...
library Item {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "ggg", name: "Item", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x746267676700000000000000000000004974656d000000000000000000000000);
